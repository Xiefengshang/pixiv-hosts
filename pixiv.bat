...
del download\*.md
pause
aria2c.exe -d download https://raw.githubusercontent.com/SNSLogty/pixiv-hosts/master/hosts.md
aria2c.exe -d download https://raw.githubusercontent.com/SNSLogty/pixiv-hosts/master/host2.md
cls
echo 注意:用管理员权限打开
echo 1.加载p站hosts并备份原来的hosts
echo 2.恢复原来的hosts(先有备份)
...
goto create
:create
aria2c.exe -d download https://raw.githubusercontent.com/SNSLogty/pixiv-hosts/master/hosts
if exist hosts (echo download complete) else (goto err)
goto create1
:create1
copy %systemdrive%\Windows\System32\drivers\etc\hosts backup\bchosts
...
:recover1
cd 
move /y %~dp0backup\bchosts C:\Windows\System32\drivers\etc\hosts
echo done2
pause
exit
:noaria
